...
/* ═══════════════════════════════════════════════════════════
   Risk Matrix Data
   ═══════════════════════════════════════════════════════════ */
// Columns: Expected Status next month
const columns = [
  "Ödenecek",
  "1-30 Gün",
  "31-60 Gün",
...
const rows = [
  {
    label: "Vadesiz",
    cells: [
      { val: "85%", color: "bg-emerald-500/10 text-emerald-400" }, // Ödenecek
      { val: "10%", color: "bg-orange-500/20 text-orange-300" },   // 1-30 Gün
      { val: "4%", color: "bg-orange-500/40 text-orange-200" },    // 31-60 Gün
      { val: "1%", color: "bg-red-500/50 text-red-200" },          // 61-90 Gün
      { val: "0%", color: "bg-zinc-800/40 text-zinc-500" },        // Batık
    ],
  },
  {
    label: "1-30 Gün",
