export const dashboardData = {
  ...
  pipelineDetails: {
    triggerLog: "Modül 1 → Risk 0.363 + Modül 3 → GREEN", confidence: "%11", urgency: "DÜŞÜK", timestamp: "2026-04-04T18:49:00", weakestLink: "892.773 TL", strongestLink: "7.918.815 TL",
    cashFlow: { weekly: "290.203 TL", monthly: "5.940.041 TL", quarterly: "54.880.817 TL" }
  },
  accounts: [
    { 
      id: "0095", name: "Demirören Yapı A.Ş.", tier: 1, exposure: "18.666.794 TL", riskBucket: "Low Risk", overdue: 668, expectedRecovery: "12.133.416 TL", actionType: "FORMAL DEMAND", 
    ...
    { id: "0378", name: "Ağaoğlu Grup", tier: 1, exposure: "14.588.572 TL", riskBucket: "Low Risk", overdue: 831, expectedRecovery: "9.482.572 TL", actionType: "FORMAL DEMAND", aiInstruction: "Hesap 0378 yöneticisini BUGÜN ara; 831 günlük gecikme gerekçesiyle acil görüşme talep et.", steps: [{ id: "s2-1", day: "Gün 1", title: "Acil görüşme talep et.", aiInstruction: "Telefonda yapılandırma sun." }] },
    { id: "0015", name: "Kalyon İnşaat", tier: 2, exposure: "18.105.081 TL", riskBucket: "Low Risk", overdue: 735, expectedRecovery: "12.311.455 TL", actionType: "BLOCK & RESTRUCTURE", aiInstruction: "ERP'de yeni vadeli satış girişlerini BUGÜN blokla; %20 peşin zorunlu yapılandırma gönder.", steps: [{ id: "s3-1", day: "Gün 1", title: "Satışları blokla.", aiInstruction: "ERP'de hesabı durdur." }] },
    { id: "0086", name: "Limak Holding", tier: 2, exposure: "17.036.870 TL", riskBucket: "Low Risk", overdue: 877, expectedRecovery: "11.585.072 TL", actionType: "BLOCK & RESTRUCTURE", aiInstruction: "ERP'de yeni vadeli satışları blokla ve resmi yapılandırma teklifi gönder.", steps: [{ id: "s4-1", day: "Gün 1", title: "Satışları blokla.", aiInstruction: "ERP engeli koy." }] },
    { id: "0156", name: "Rönesans Holding", tier: 3, exposure: "12.785.663 TL", riskBucket: "Low Risk", overdue: 829, expectedRecovery: "11.251.383 TL", actionType: "PROACTIVE OUTREACH", aiInstruction: "Bu hafta değer görüşmesi yap; %1.5 erken ödeme iskontosu teklif et.", steps: [{ id: "s5-1", day: "Gün 1", title: "İskonto teklifi sun.", aiInstruction: "15 gün geçerli iskonto maili at." }] },
    { id: "0190", name: "Cengiz Holding", tier: 3, exposure: "10.278.808 TL", riskBucket: "Medium Risk", overdue: 792, expectedRecovery: "9.045.351 TL", actionType: "PROACTIVE OUTREACH", aiInstruction: "Bu hafta değer görüşmesi yap; %1.5 erken ödeme iskontosu teklif et.", steps: [{ id: "s6-1", day: "Gün 1", title: "İskonto teklifi sun.", aiInstruction: "Müşteri başarı görüşmesi yap." }] }
  ]
};
